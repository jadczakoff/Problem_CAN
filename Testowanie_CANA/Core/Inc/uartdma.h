...
uint8_t UARTDMA_IsDataReceivedReady(UARTDMA_HandleTypeDef *huartdma); // Check if something was received
uint8_t UARTDMA_GetLineFromReceiveBuffer(UARTDMA_HandleTypeDef *huartdma, char *OutBuffer); // Get one line from receive Ring Buffer
